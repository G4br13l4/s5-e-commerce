...
## It is an ecommerce, a Single Page Application,  that consists of the simulation of product sale through Mercado Libre API and payment with Paypal API. Also uses Firebase for the login and LocalStorage to store the information of the user's session.
...
## The name of user appears and its profile image in the upper right corner, indicating that you have successfully logged in.
